...
func GetHome(c *fiber.Ctx) error {
	...
	return c.Render("home", fiber.Map{
		...
		"local_activity": template.HTML(svg.GetIcon("local_activity")),
		"devices":        template.HTML(svg.GetIcon("devices")),
		"apps":           template.HTML(svg.GetIcon("apps")),
		"contacts":       template.HTML(svg.GetIcon("contacts")),
		"analytics":      template.HTML(svg.GetIcon("analytics")),
		"traffic":        template.HTML(svg.GetIcon("traffic")),
		"lan":            template.HTML(svg.GetIcon("lan")),
		"settings":       template.HTML(svg.GetIcon("settings")),
		"info":           template.HTML(svg.GetIcon("info")),
		"exit_to_app":    template.HTML(svg.GetIcon("exit_to_app")),
		"person":         template.HTML(svg.GetIcon("person")),
	})
}
