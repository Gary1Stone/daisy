...
CREATE TABLE icons (id INTEGER NOT NULL UNIQUE, name TEXT NOT NULL UNIQUE, description TEXT NOT NULL, color TEXT NOT NULL, priority INTEGER NOT NULL, icon TEXT NOT NULL, is_device INTEGER NOT NULL DEFAULT 0, icon2 TEXT NOT NULL DEFAULT "", PRIMARY KEY (id AUTOINCREMENT));
...
CREATE TABLE mac_correlation (mac1 TEXT NOT NULL DEFAULT "", mac2 TEXT NOT NULL DEFAULT "", corr INTEGER NOT NULL DEFAULT (- 1), site TEXT NOT NULL DEFAULT "", pearson INTEGER NOT NULL DEFAULT (- 1), jaccard INTEGER NOT NULL DEFAULT (- 1), slots INTEGER NOT NULL DEFAULT (0), overlap INTEGER DEFAULT (0) NOT NULL, PRIMARY KEY (mac1 ASC, mac2 ASC)) STRICT;
...
CREATE TABLE vendors (MacPrefix TEXT PRIMARY KEY NOT NULL, Vendor TEXT NOT NULL DEFAULT "", Private INTEGER NOT NULL DEFAULT (0), BlockType TEXT NOT NULL DEFAULT "", LastUpdate TEXT NOT NULL DEFAULT "") STRICT;
