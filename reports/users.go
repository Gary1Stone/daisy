...
func GetUsersReport(curUid int) string {
	...
	report.WriteString("<th aria-sort='none'>User</th>")
	report.WriteString("<th aria-sort='none'>Last Login</th>")
	report.WriteString("<th aria-sort='none'>Location</th>")
	report.WriteString("<th aria-sort='none'>Active</th>")
	report.WriteString("<th aria-sort='none'>Banned</th>")
	report.WriteString("</tr>")
	report.WriteString("</thead>")
